...
class Baralho:
    ...
    def __obter_cartas(self):
        return [
           Carta('A', 'copas'), Carta('2', 'copas'), Carta('3', 'copas'), Carta('4', 'copas'), Carta('5', 'copas'), Carta('6', 'copas'), Carta('7', 'copas'), Carta('8', 'copas'), Carta('9', 'copas'), Carta('10', 'copas'), Carta('J', 'copas'), Carta('Q', 'copas'), Carta('K', 'copas'),
